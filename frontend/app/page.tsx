...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-gray-200/60 z-50 transition-all duration-300">
      ...
      <section className="relative pt-40 pb-32 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 mb-8 animate-fade-in hover:scale-105 transition-transform duration-300">
            <Sparkles className="h-4 w-4 text-gray-900 animate-pulse" strokeWidth={1.5} />
            <span className="text-sm font-light text-gray-700">Propulsé par l'IA</span>
          </div>

          <h1 className="text-6xl lg:text-7xl xl:text-8xl font-light text-gray-900 mb-8 leading-tight tracking-tight animate-fade-in-up">
            Transformez vos vidéos<br />en contenu viral
          </h1>

          <p className="text-xl lg:text-2xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto font-light animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <Link
              href="/register"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-all hover:shadow-lg hover:scale-105 duration-300"
            >
            ...
            <Link
              href="#features"
              className="inline-flex items-center gap-3 px-8 py-4 border border-gray-300 text-gray-900 rounded-xl hover:border-gray-400 hover:shadow-md transition-all duration-300 hover:scale-105"
            >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-gray-200 group-hover:border-gray-300 group-hover:shadow-md transition-all duration-300">
                <Video className="h-8 w-8 text-gray-900 group-hover:scale-110 transition-transform duration-300" strokeWidth={1.5} />
              </div>
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-gray-200 group-hover:border-gray-300 group-hover:shadow-md transition-all duration-300">
                <Sparkles className="h-8 w-8 text-gray-900 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300" strokeWidth={1.5} />
              </div>
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-gray-200 group-hover:border-gray-300 group-hover:shadow-md transition-all duration-300">
                <FileText className="h-8 w-8 text-gray-900 group-hover:scale-110 transition-transform duration-300" strokeWidth={1.5} />
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-gray-300 hover:shadow-lg transition-all duration-300 hover:scale-105">
              ...
              <Link
                href="/register"
                className="block w-full px-6 py-3 border border-gray-300 text-gray-900 text-center rounded-lg hover:border-gray-400 hover:shadow-md transition-all duration-300 font-medium"
              >
                Commencer
              </Link>
            </div>
            ...
            {/* Pro Plan */}
            <div className="bg-gray-900 border border-gray-900 rounded-2xl p-8 transform scale-105 shadow-xl hover:scale-110 hover:shadow-2xl transition-all duration-300">
              ...
              <Link
                href="/register"
                className="block w-full px-6 py-3 bg-white text-gray-900 text-center rounded-lg hover:bg-gray-100 hover:shadow-md transition-all duration-300 hover:scale-105 font-medium"
              >
                Commencer
              </Link>
            </div>
      ...
      <section className="py-32 px-6 lg:px-12 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6 tracking-tight animate-fade-in-up">
            Prêt à transformer vos vidéos ?
          </h2>
          <p className="text-xl text-gray-600 mb-10 font-light animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            Rejoignez des milliers de créateurs qui utilisent déjà Vidova
          </p>
          <Link
            href="/register"
            className="group inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white rounded-xl hover:bg-gray-800 hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in-up"
