    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Aucune vidéo</h2>
          <p className="text-gray-600 mb-6">Commencez par soumettre une vidéo depuis le dashboard</p>
          <Link
            href="/dashboard"
