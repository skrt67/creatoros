      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <h3 className="text-sm font-bold text-white mb-4">Newsletter</h3>
            ...
            <form className="flex flex-col gap-2">
              <input
                ...
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-gradient-to-r from-primary-600 to-purple-600 hover:from-primary-700 hover:to-purple-700 text-white text-sm font-semibold rounded-lg transition-all"
              >
                S'abonner
              </button>
            </form>
